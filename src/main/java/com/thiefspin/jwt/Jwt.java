...
public class Jwt {
     ...
     * @return {@link com.thiefspin.jwt.JwtEncodeResult}
     */
     ...
     * @param secret    key to encrypt signature with
     * @param payload   String data to encode into JWT token
     * @param algorithm Algorithm to sign token with {@link com.thiefspin.jwt.Algorithm}
     * @return {@link com.thiefspin.jwt.JwtEncodeResult}
     */
     ...
     * Returns JWTException {@link com.thiefspin.jwt.JwtException} if any error occurs.
     *
     ...
     * @return {@link com.thiefspin.jwt.JwtDecodeResult}
     */
